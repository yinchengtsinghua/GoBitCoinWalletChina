...
//TestBlockFilterOneOut测试中BlockFilter的正确性
//从“被监视的输出点”中查找花费的输出点，即使它们不
//发送到钱包控制的地址。
func TestBlockFiltererOneInOneOut(t *testing.T) {
//在第一个和最后一个Tx中注意上一个的花费，这两个都是
//单输入/单输出。
...
//断言numrrelevanttxns检查在块中找到的相关txns集
//过滤器具有特定大小。
...
//断言相关的ttxnscontains检查是否在块中找到wanttx
//相关TXN的过滤器组。
